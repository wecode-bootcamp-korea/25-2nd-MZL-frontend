...
function Booking() {
  ...
  // const getSelectFlight = props => {
  //   setSelectFlight(ticket => [...ticket, props]);
  ...
  return (
    <BigContainer>
      <SearchList>날짜날</SearchList>
      <SelectFlight>
        {selectFlight?.map(selected => (
          <Ticket
            key={selected.id}
            list={selected}
            isLength={selectFlight[1] === false}
          ></Ticket>
        ))}
        {isLength2 ? (
          <Btn to={{ pathname: '/book', state: selectFlight }}>
            다음페이지로
          </Btn>
        ) : (
          ''
        ...
        <Container>
          ...
          <Bookings>
            ...
            <Data>
              ...
              <DirectionDate>10월22일</DirectionDate>
            </Data>
            <Filgths>
